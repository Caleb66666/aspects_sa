# @File: word_char_with_cnn
# @Author : Caleb
# @Email: VanderLancer@gmail.com
# @time: 2020/2/27 18:27:42
...
class TestWordCharEmbeddingWithCnnClass(unittest.TestCase):
    def setUp(self):
        super(TestWordCharEmbeddingWithCnnClass, self).setUp()
    ...
    def test_embed_output_size(self):
        ...
        predict_size = torch.Size(
            [self.batch_size, self.max_seq, self.word_embed_size + self.n_channel * len(self.kernel_sizes)])

# @File: better_transfer_loader
# @Author : Caleb
# @Email: VanderLancer@gmail.com
# @time: 2020/3/15 21:39:02
...
from utils.path_util import nps_serialize, nps_deserialize
...
class TrainLoader(BaseLoader):
    ...
    def _workflow(self):
        ...
        tokenizer = BertTokenizer.from_pretrained(self.config.transfer_path)
